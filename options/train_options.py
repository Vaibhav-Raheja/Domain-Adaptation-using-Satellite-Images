...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--log_freq', type=int, default=400, help='frequency of showing training results on screen')
        ...
        parser.add_argument('--isTrain', action='store_true', help='if specified, model is in training mode')
