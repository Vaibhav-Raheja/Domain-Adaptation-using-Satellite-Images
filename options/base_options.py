...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # new custom params
        parser.add_argument('--num_test_images', type=int, default=1000, help='if specified, model is in training mode')
        parser.add_argument('--dirA', type=str, default='trainA', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dirB', type=str, default='trainB', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--short_side_thresh', type=int, default=512, help='target width for resizing')
        parser.add_argument('--long_side_thresh', type=int, default=768, help='target height for resizing')
        parser.add_argument('--save_image_prefix_len', type=int, default=1,
                            help='dir structure to store the images')
